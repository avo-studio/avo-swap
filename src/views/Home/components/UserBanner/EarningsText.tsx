...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and AVOX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and AVOX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from AVOX pool', data)
  }
