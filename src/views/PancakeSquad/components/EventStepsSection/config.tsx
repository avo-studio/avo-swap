  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active AVO STUDIO Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold AVOX'),
      bodyText: [t('Each NFT costs AVOX to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://swap.avostudio.io/swap?outputCurrency=0x6961f579C27CBEd392FCbaA076d84350C1B9660D"
            target="_blank"
            width="100%"
          >
            {t('Buy AVOX')}
