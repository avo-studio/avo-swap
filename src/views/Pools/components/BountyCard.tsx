...
const BountyCard = () => {
  ...
  const TooltipComponent = ({ fee }: { fee: number }) => (
    <>
      ...
      <Text mb="16px">
        {t(
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto AVOX Pool’s compounding function for everyone.',
        )}
      </Text>
      <Text style={{ fontWeight: 'bold' }}>
        {t('Auto-Compound Bounty: %fee%% of all Auto AVOX pool users pending yield', { fee: fee / 100 })}
      </Text>
    </>
  )
