...
const Hero = () => {
  ...
  const getHeroHeading = () => {
    if (status === LotteryStatus.OPEN) {
      return (
        <>
          ...
          <Heading mb="32px" scale="lg" color="#b5179e">
            {t('in prizes!')}
          </Heading>
        </>
      )
    ...
    return (
      <Heading mb="24px" scale="xl" color="#b5179e">
  ...
  return (
    <Flex flexDirection="column" alignItems="center" justifyContent="center">
      ...
      <Heading mb="8px" scale="md" color="#b5179e" id="lottery-hero-title">
        {t('The AVO STUDIO Lottery')}
      </Heading>
      {getHeroHeading()}
      <TicketContainer
        position="relative"
