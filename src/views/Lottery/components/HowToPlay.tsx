  ...
  const steps: Step[] = [
    {
      ...
      title: t('Buy Tickets'),
      subtitle: t('Prices are set when the round starts, equal to 5 USD in AVOX per ticket.'),
    },
    {
      ...
      <GappedFlex flexDirection={['column', 'column', 'column', 'row']}>
        <Flex flex="2" flexDirection="column">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t('100% of the AVOX paid by people buying tickets that round goes back into the prize pools.')}
              </Text>
            </li>
          </BulletList>
          <Heading my="16px" scale="md">
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'After every round, if nobody wins in one of the prize brackets, the unclaimed AVOX for that bracket rolls over into the next round and are redistributed among the prize pools.',
                )}
              </Text>
            </li>
          </BulletList>
          ...
          <BulletList>
            <li>
              <Text display="inline" color="textSubtle">
                {t(
                  'An average total of 35,000 AVOX from the treasury is added to lottery rounds over the course of a week. This AVOX is of course also included in rollovers! Read more in our guide to ',
                )}
                <InlineLink href="https://AVO STUDIO.gitbook.io/AVO STUDIO-documentation/tokenomics/astro">
                  {t('AVOX Tokenomics')}
                </InlineLink>
              </Text>
            </li>
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            ...
            <InlineLink href="https://AVO STUDIO.gitbook.io/AVO STUDIO-documentation/products/lottery/how-to-play-lottery">
              {t('how to play the AVO STUDIO lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
